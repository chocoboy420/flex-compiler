...
You can modify the lexer rules to: Add new keywords Support new operators Recognize strings or comments Build a full parser using Bison/Yacc If you need help extending it, feel free to ask!
